...
VentaRiko is an AI-driven retail inventory optimization system that helps store managers identify products that may require markdowns and generate dynamic discount recommendations.
...
The VentaRiko dashboard combines inventory information, recent sales activity, remaining shelf life, and machine-learning-generated discount recommendations.

![VentaRiko Dashboard](screenshots/dashboard.png)
...
The system predicts a recommended discount percentage based on the available inventory and recent sales information.
...
The system uses inventory and sales information to prepare the features required by the machine-learning model.

### 5. ML Prediction

The Random Forest regression model predicts a discount percentage.
...
The synthetic target is generated using inventory-related conditions such as:
...
An example result from the application can look like:

| Product         | Status          | Stock | Sales (7D) | Days Left | AI Discount |
| --------------- | --------------- | ----: | ---------: | --------: | ----------: |
| Apples          | Urgent Discount |    60 |          8 |         2 |      38.59% |
| Dettol Handwash | Urgent Discount |   200 |          5 |         3 |      46.54% |
| Sliced Bread    | Expiring Soon   |   120 |         65 |         5 |      26.96% |
| Coca-Cola       | Expiring Soon   |   180 |         18 |         8 |      14.05% |
| Basmati Rice    | AI Discount     |   150 |         25 |        20 |       3.34% |
| Block Cheese    | AI Discount     |    50 |          2 |        35 |       0.66% |

> Example predictions depend on the inventory and sales data provided to the application and may vary between runs or datasets.
...
Prepare the relevant features and identify inventory conditions that may require attention.
...
> Update this structure if you rename or reorganize files in the repository.
...
> The dependency versions in `requirements.txt` should correspond to the environment used to train and serialize the included machine-learning model.
...
The application will start on the local server address displayed by Uvicorn.
...
* The recommendation quality depends on the quality and completeness of inventory and sales data.
...
* Discount recommendations should be reviewed by a human decision-maker before being applied in a real retail environment.
